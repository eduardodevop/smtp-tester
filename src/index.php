...
<html lang="es">
  ...
  <body x-data="alpineData()">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom animate__animated animate__fadeInDown noselect">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="img/mail.svg" alt="SMTP Tester">&nbsp;&nbsp;SMTP Tester
        </a>
        <a href="https://github.com/eduardodevop/smtp-tester" target="_blank" class="ml-auto">
    ...
    <form method="POST" action="<?php echo $actual_link; ?>" enctype="multipart/form-data" name="mailForm" id="mailForm">
      ...
      <div class="px-2 animate__animated animate__fadeIn animate__slow noselect">
        ...
        <div class="container my-3 bg-light rounded border p-3">
          <h4>SMTP Details</h4>
